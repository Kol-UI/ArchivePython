...
def Game_Center(maSurface):
    ...
    pygame.draw.circle(maSurface, (255, 0, 0), (639, 710), 6, 0)
    ...
    # Flipper
    pygame.draw.line(maSurface, (255, 255, 255), (520, 644), (617, 644),5)
    pygame.draw.line(maSurface, (255, 255, 255), (660, 644), (757, 644),5)
